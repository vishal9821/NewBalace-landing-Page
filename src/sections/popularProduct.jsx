  ...
  return (
      <section id='products' className='max-container max-sm:mt-12'>
         <div className='flex flex-col justify-start gap-5'>
           ...
           <p className='font-montserrat text-slate-gray lg:max-w-lg mt-2'>Experience top-notch quality abd style with our sought-after selecetions.Discover a world of comfort, design and value.</p>
         </div>
